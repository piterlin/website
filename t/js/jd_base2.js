...
function init3D() {
 ...
 //   m_camera.position.set(0, 0, 5);
    ...
    m_effect.setSize( m_main_view_width, m_main_view_height );
}
/**
 * 窗口尺寸变化处理器
 * */
function onWindowResize() {
    updateSize();
    m_camera.aspect = m_main_view_width/ m_main_view_height;
    m_camera.updateProjectionMatrix();
    m_effect.setSize( m_main_view_width,m_main_view_height );
}
...
function updateSize() {
    var displayView = $("#3d_content");
    m_main_view_width = window.innerWidth - displayView.offset().left-5;
    m_main_view_height = window.innerHeight - displayView.offset().top-5;
}
